...
class MkDocsQuizPlugin(BasePlugin):
    ...
    def on_page_markdown(self, markdown, page, config, **kwargs):
        ...
        for match in matches:
            ...
            quiz = '<div class="quiz"><h3>{}</h3><form><fieldset>{}</fieldset><button type="submit" class="quiz-button">Valider</button></form><section class="content hidden">{}</section></div>'.format(
